...
namespace ApiProyectoWeb.Controllers
{
    ...
    public class VoteController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] Vote newVote)
        {
            var result = await _service.Create(newVote);
            return CreatedAtAction(nameof(GetById), new { id = result.id_vote }, result);
        }
